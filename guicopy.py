...
class ChatWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.port_label.setText(f"Your Port: 12346")
    ...
    # def save_message_to_firebase(self, message, sender, receiver):
    #     self.chat_id = self.server_socket
    #     self.firestore.add_data3(self.user_email,sender,receiver,{"message": message, "receiver": receiver, "sender": sender, "sent_at": time.time()})
